                    ...
                    if($cat_tab1_query->have_posts()){ // Check Have Posts Or No
                        while($cat_tab1_query->have_posts()){
                            ...
                            <div class="body-post">
                                ...
                                <!-- End Category index post outhor --->
